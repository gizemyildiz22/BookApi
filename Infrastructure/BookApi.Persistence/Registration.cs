...
using BookWebApi.Persistence.UnitOfWorks;
...
namespace BookWebApi.Persistence
{
    public static class Registration
    {
        public static void AddPersistence(this IServiceCollection services,IConfiguration configuration) 
        {
            services.AddDbContext<BookApiDbContext>(opt => opt.UseSqlServer(configuration.GetConnectionString("MyCon")));
            ...
            services.AddIdentityCore<User>(opt=>
            {
                ...
                .AddRoles<Role>()
                .AddEntityFrameworkStores<BookApiDbContext>();
